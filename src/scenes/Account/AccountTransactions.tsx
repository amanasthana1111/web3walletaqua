        ...
        <tbody>
          {transactions.map((transaction) => (
            <tr key={transaction.hash}>
              <td>
                <a
                  href={`${sepolia.blockExplorerUrl}/tx/${transaction.hash}`} // Updated for Sepolia
                  target="_blank"
              ...
              <td>
                <a
                  href={`${sepolia.blockExplorerUrl}/address/${transaction.from_address}`} // Updated for Sepolia
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <td>
                <a
                  href={`${sepolia.blockExplorerUrl}/address/${transaction.to_address}`} // Updated for Sepolia
                  target="_blank"
                  rel="noopener noreferrer"
                >
